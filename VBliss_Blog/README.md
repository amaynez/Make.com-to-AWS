...
```bash
VBliss_Blog$ pip install -r tests/requirements.txt --user
# unit test
VBliss_Blog$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
VBliss_Blog$ AWS_SAM_STACK_NAME="vbliss_blog" python -m pytest tests/integration -v
```
...
```bash
sam delete --stack-name "vbliss_blog"
```
