...
def invoke_bedrock_model(prompt):
    ...
    print("Debug: output_body =", output_body) 
    if "images" in output_body and output_body["images"]:
        return base64.b64decode(output_body["images"][0])
    else:
        print("Error: 'images' key not found in the model output or it's empty")
        print("Available keys:", output_body.keys())
        raise KeyError("The 'images' key was not found in the model output")
